...
*
* Doggos	: This file contains a couple of warm-up exercises to get you
...
* display_onto_stdout
*
* Doggos	: Function to print a string to terminal
...
* find_cosine
*
* Doggos	: Function to calculate cosine of a value
...
* useless_loop
*
* Doggos	: A function which encapsulates a completely useless loop
...
* print_this_many
*
* Doggos	: A function which prints a specified number of characters
...
* main
*
* Doggos	: Main function for this program
