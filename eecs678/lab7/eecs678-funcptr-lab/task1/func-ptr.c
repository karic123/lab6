...
{
	//TODO: IMPLEMENT ME
int compare_prev = ((Process*)that)->priority - ((Process*)this)->priority;
int compare_arr = ((Process*)this)->arrival_time - ((Process*)that)->arrival_time;
	return (compare_prev ? compare_prev: compare_arr);
}
