...
int main (int argc, char *argv[])
{
   ...
   */
	...
	{
		printf("ERROR: issue with finding file size\n");
	}
   ...
   */
   ...
   {
	   printf("ERROR: couldn't find last byte.\n");
   }
   ...
   */
	...
	if(write(fdout, "", 1) == -1)
	{
		printf("ERROR: could not write dummy byte.\n");
	}
   ...
   */
	...
	{
		printf("ERROR: issue with using mmap on the input file\n");
	}
   ...
   */
   	...
   	{
   		printf("ERROR: issue with using mmap on the output file\n");
   	}
